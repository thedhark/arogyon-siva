...
export default function HospitalInfoPage() {
  ...
  const storeHospital = params.id ? storeHospitals[params.id] : null;

  const hospitalName = storeHospital?.name || params.hospitalName || 'Apollo Hospital';
  const location = storeHospital?.location || params.location || 'Old Airport Road, Bangalore';
  const phone = (storeHospital as any)?.phone || params.phone || '08022223333';
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? '#121212' : '#FFFFFF' }]}>
      ...
      {/* Dynamic Safe Area Header Bar - Borderless & Properly Padded */}
      <View style={[
        styles.headerBar, 
        { 
      ...
      >
        {/* Hospital Header Title Card - Free, Borderless & Shadowless */}
      ...
      {/* Bottom Fixed Action Bar - Padded with Insets */}
      <View style={[
        ...
        <TouchableOpacity style={styles.goBackBtn} onPress={() => router.back()} activeOpacity={0.9}>
