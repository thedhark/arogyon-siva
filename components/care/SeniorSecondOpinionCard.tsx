...
import { Award, FileText, Clock, ShieldCheck } from 'lucide-react-native';
import * as Haptics from 'expo-haptics';
import { BlurView } from 'expo-blur';
import { LinearGradient } from 'expo-linear-gradient';
import { useTheme } from '@/hooks/useTheme';

interface SeniorSecondOpinionCardProps {
  onPress?: () => void;
}

export default function SeniorSecondOpinionCard({ onPress }: SeniorSecondOpinionCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Image
          source={require('@/assets/images/second_opinion_hero_realistic.jpg')}
          style={styles.backgroundImage}
          resizeMode="cover"
        />

        {/* Soft top gradient for crisp text readability */}
        <LinearGradient
          colors={['rgba(255,255,255,0.88)', 'rgba(255,255,255,0.45)', 'transparent']}
        ...
        <View style={styles.topContentOverlay}>
          <Text style={styles.mainHeading}>
            Senior Specialist{'\n'}2nd Opinion,{'\n'}
            <Text style={styles.countryHighlight}>Care.</Text>
          </Text>
          <Text style={styles.subtitleText}>
            Verify critical diagnoses &{'\n'}avoid unnecessary surgeries.
          </Text>
        ...
        <View style={styles.bottomCapsuleWrap}>
          ...
          >
            ...
            {/* Feature 2: Scan Review */}
            <View style={styles.featureCol}>
              <View style={[styles.iconCircle, { backgroundColor: isDark ? 'rgba(16, 185, 129, 0.2)' : '#ECFDF5' }]}>
                <FileText size={18} color={isDark ? '#34D399' : '#059669'} strokeWidth={2.4} />
              </View>
              <Text style={[styles.featureTitle, { color: isDark ? '#FFFFFF' : '#0F172A' }]}>
                Scan{'\n'}Review
              </Text>
              <Text style={[styles.featureSub, { color: isDark ? '#94A3B8' : '#64748B' }]}>
                Detailed MRI & CT analysis.
              </Text>
            </View>
