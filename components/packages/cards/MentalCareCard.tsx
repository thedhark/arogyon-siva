...
export default function MentalCareCard({ onPress }: CardProps) {
  ...
  const handlePress = () => {
    if (onPress) {
      ...
      router.push('/packages/category/mental' as any);
    }
  };
    ...
    >
      ...
      >
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <Image source={resolveImageSource(MEDICAL_ILLUSTRATIONS.mental)} style={styles.image} resizeMode="cover" />
        </View>
