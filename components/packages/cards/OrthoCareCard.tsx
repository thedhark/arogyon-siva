...
export default function OrthoCareCard({ onPress }: CardProps) {
  ...
  const handlePress = () => {
    if (onPress) {
      ...
      router.push('/packages/category/ortho' as any);
    }
  };
    ...
    >
      ...
      >
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <Image source={resolveImageSource(MEDICAL_ILLUSTRATIONS.orthopedics)} style={styles.image} resizeMode="cover" />
        </View>
