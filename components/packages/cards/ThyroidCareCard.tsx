    ...
    >
      ...
      >
        <View style={styles.content}>
          <Text style={styles.title} numberOfLines={1}>Thyroid & Hormone Care</Text>
          <Text style={styles.subtitle} numberOfLines={2}>T3, T4, TSH panel & endocrinologist care</Text>
        </View>
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <Image source={resolveImageSource(MEDICAL_ILLUSTRATIONS.thyroid)} style={styles.image} resizeMode="cover" />
        </View>
