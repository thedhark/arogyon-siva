...
export default function PregnancyCareCard({ onPress }: CardProps) {
  ...
  return (
    ...
    >
      <LinearGradient
        colors={['#FDEEF4', '#EED2DF']}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 0 }}
        style={styles.cardGradient}
      >
        <View style={styles.content}>
          <Text style={styles.title} numberOfLines={1}>Pregnancy Care Plan</Text>
          <Text style={styles.subtitle} numberOfLines={2}>Complete care for you & your baby</Text>
        </View>
        
        <View style={styles.imageContainer}>
          <LinearGradient 
            colors={['#FDEEF4', 'transparent']} 
            start={{ x: 0, y: 0 }} 
            end={{ x: 0.6, y: 0 }} 
