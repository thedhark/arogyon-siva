...
export default function DiabetesCareCard({ onPress }: CardProps) {
    ...
    >
      ...
      >
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <Image source={resolveImageSource(MEDICAL_ILLUSTRATIONS.diabetes)} style={styles.image} resizeMode="cover" />
        </View>
