...
export default function SeniorCareCard({ onPress }: CardProps) {
  ...
  const handlePress = () => {
    if (onPress) {
      ...
      router.push('/packages/category/senior' as any);
    }
  };
    ...
    >
      ...
      >
        ...
        <View style={styles.imageContainer}>
          ...
          />
          <Image source={resolveImageSource(MEDICAL_ILLUSTRATIONS.senior)} style={styles.image} resizeMode="cover" />
        </View>
