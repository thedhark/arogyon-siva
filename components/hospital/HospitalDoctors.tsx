...
import { Search, HeartPulse, Bone, Brain, Ribbon, SlidersHorizontal, ArrowUpDown, X, CheckCircle2 } from 'lucide-react-native';
...
export default function HospitalDoctors({ doctors, likedDocs, toggleDocLike, colors, isDark }: Props) {
  ...
  return (
    <View style={styles.tabContent}>
      ...
      {/* All Categories Modal when tapping +12 */}
      <Modal visible={showCategoryModal} transparent animationType="slide" onRequestClose={() => setShowCategoryModal(false)}>
        <View style={styles.modalOverlay}>
          <View style={[styles.modalCard, { backgroundColor: isDark ? '#1E1E24' : '#FFFFFF' }]}>
            <View style={styles.modalHeader}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>Select Doctor Specialty</Text>
