...
export const CATEGORY_INDEX_REGISTRY: Record<string, CategoryIndex> = {
  ...
  heart: {
    ...
    emoji: '❤️',
    heroImage: require('../assets/images/package-banners/cardiac_care.png'),
  ...
  kidney: {
    id: 'kidney',
    aliases: ['renal', 'nephrology', 'kidney-stone', 'urology', 'prostate', 'urinary', 'mens-urology', '13', '14'],
    title: 'KIDNEY & UROLOGY CARE',
    subtitle: 'Kidney function test, stone evaluation, urinary & prostate health',
    emoji: '🫘',
    heroImage: require('../assets/images/package-banners/kidney_and_urinary.png'),
    offer: '30% OFF KIDNEY & UROLOGY PACKAGES',
    cardColors: ['#F0F9FF', '#E0F2FE', '#BAE6FD'],
    cardBadge: 'RENAL & UROLOGY',
    subcategories: [
    ...
    packages: [
      ...
      },
      {
        ...
        categoryId: 'kidney',
        subcategory: 'Laser Kidney Stone Removal',
