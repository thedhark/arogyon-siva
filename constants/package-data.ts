...
export const CATEGORY_INDEX_REGISTRY: Record<string, CategoryIndex> = {
  ...
  hair: {
    ...
    emoji: '💇',
    heroImage: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=1000',
  ...
  dental: {
    ...
    emoji: '🦷',
    heroImage: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?q=80&w=1000',
  ...
  women: {
    id: 'women',
    aliases: ['pregnancy', 'maternity', 'gynecology', 'pcos', 'womens', '9'],
    title: "WOMEN'S HEALTH & MATERNITY CARE",
    subtitle: 'Gynecology checkups, pregnancy care, PCOS & breast screening',
    emoji: '👩',
  ...
  fertility: {
    ...
    emoji: '🧬',
    heroImage: 'https://images.unsplash.com/photo-1581595220892-6e8e54346bce?q=80&w=1000',
    ...
    packages: [
      {
        ...
        originalPrice: '₹9,000',
        discount: '44% OFF',
        image: 'https://images.unsplash.com/photo-1581595220892-6e8e54346bce?q=80&w=600',
  ...
  digestive: {
    ...
    emoji: '🍽️',
    heroImage: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?q=80&w=1000',
